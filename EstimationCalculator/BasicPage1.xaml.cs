using EstimationCalculator.Common;
using System;
    ...
    public sealed partial class BasicPage1 : Page
    {
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            foreach (Player_history plhi in plhiList)
            {
                ...
                temp = new TextBlock();
                temp.FontSize = 18;
                temp.Text = plhi.King.ToString();
                king.Items.Add(temp);
                temp = new TextBlock();
                temp.FontSize = 18;
                temp.Text = plhi.subking.ToString();
                subking.Items.Add(temp);
                temp = new TextBlock();
                temp.FontSize = 18;
                temp.Text = plhi.subkooz.ToString();
                subkooz.Items.Add(temp);
                temp = new TextBlock();
                temp.FontSize = 18;
                temp.Text = plhi.kooz.ToString();
                kooz.Items.Add(temp);
        ...
        private async void button1_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                DataContractJsonSerializer serializer = new DataContractJsonSerializer(typeof(List<Player_history>));
                serializer.WriteObject(stream, new List<Player_history>());
